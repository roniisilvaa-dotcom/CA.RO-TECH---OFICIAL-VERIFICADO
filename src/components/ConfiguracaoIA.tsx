...
export const ConfiguracaoIA: React.FC<ConfiguracaoIAProps> = ({ empresaId }) => {
  ...
  if (loading || !config) {
    return (
      <div className="max-w-7xl mx-auto p-8 text-center text-slate-400 text-xs">
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="bg-[#0E182A]/90 rounded-2xl border border-[#D4AF37]/30 p-6 space-y-5 shadow-2xl backdrop-blur-md">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setConfig({ ...config, nomeAssistente: e.target.value })}
                placeholder="Ex: Sofia, Amanda, Atendente Virtual..."
                className="w-full bg-[#15243F] border border-[#D4AF37]/30 rounded-xl px-3.5 py-2.5 text-xs text-[#F8FAFC] placeholder-[#94A3B8] focus:outline-none focus:border-[#D4AF37]"
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setConfig({ ...config, tomDeVoz: e.target.value })}
                placeholder="Ex: cordial, objetivo, dinâmico e focado em vendas..."
                className="w-full bg-[#15243F] border border-[#D4AF37]/30 rounded-xl px-3.5 py-2.5 text-xs text-[#F8FAFC] placeholder-[#94A3B8] focus:outline-none focus:border-[#D4AF37]"
              />
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) => setConfig({ ...config, baseConhecimento: e.target.value })}
                placeholder="Cole aqui todas as informações da sua empresa: produtos, serviços, preços, endereço, horários, perguntas frequentes, políticas de garantia e formas de pagamento..."
                className="w-full bg-[#15243F] border border-[#D4AF37]/30 rounded-xl p-3.5 text-xs text-[#F8FAFC] font-mono leading-relaxed focus:outline-none focus:border-[#D4AF37] scrollbar-thin"
              />
            ...
            <div>
              ...
              <textarea
                rows={3}
                value={config.regrasEscalonamento}
                onChange={(e) => setConfig({ ...config, regrasEscalonamento: e.target.value })}
                placeholder="Ex: Se o cliente disser 'falar com humano', 'atendente' ou pedir avaliação técnica, transferir para a equipe humana..."
                className="w-full bg-[#15243F] border border-[#D4AF37]/30 rounded-xl p-3.5 text-xs text-[#F8FAFC] focus:outline-none focus:border-[#D4AF37]"
              />
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-2">
                <button
                  ...
                  className={`p-3 rounded-xl border text-xs font-bold transition flex flex-col items-center justify-center gap-1 uppercase tracking-wider text-[10px] ${
                    config.llmProvider === 'gemini'
                      ? 'bg-[#D4AF37] text-[#050B14] border-[#D4AF37] shadow-md'
                      : 'bg-[#15243F] border-[#D4AF37]/20 text-[#94A3B8] hover:text-[#F8FAFC]'
                  }`}
                >
                ...
                <button
                  type="button"
                  onClick={() => setConfig({ ...config, llmProvider: 'anthropic' })}
                  className={`p-3 rounded-xl border text-xs font-bold transition flex flex-col items-center justify-center gap-1 uppercase tracking-wider text-[10px] ${
                ...
                <button
                  type="button"
                  onClick={() => setConfig({ ...config, llmProvider: 'openai' })}
                  className={`p-3 rounded-xl border text-xs font-bold transition flex flex-col items-center justify-center gap-1 uppercase tracking-wider text-[10px] ${
            ...
            <div className="pt-2 flex items-center justify-between">
              <button
                type="submit"
                disabled={saving}
                className="bg-[#D4AF37] hover:bg-[#F3E5AB] disabled:opacity-50 text-[#050B14] font-bold px-6 py-3 rounded-xl uppercase tracking-wider text-[10px] transition flex items-center gap-2 shadow-md hover:shadow-[#D4AF37]/20"
              >
        ...
        {/* Right Live Test Playground Column */}
          ...
          <div className="bg-[#0E182A]/90 rounded-2xl border border-[#D4AF37]/30 p-6 shadow-2xl backdrop-blur-md flex flex-col h-full">
            ...
            <div className="mb-4">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  placeholder="Ex: Qual o horário de funcionamento e valor?"
                  className="flex-1 bg-[#15243F] border border-[#D4AF37]/30 rounded-xl px-3 py-2 text-xs text-[#F8FAFC] placeholder-[#94A3B8] focus:outline-none focus:border-[#D4AF37]"
                />
                <button
                  onClick={handleTestIA}
                  disabled={testing || !testQuery.trim()}
                  className="bg-[#D4AF37] hover:bg-[#F3E5AB] text-[#050B14] font-bold uppercase tracking-wider text-[10px] px-4 py-2 rounded-xl flex items-center gap-1 transition shadow-md"
                >
            ...
            <div className="flex-1 bg-[#050B14] border border-[#D4AF37]/20 rounded-xl p-4 flex flex-col">
              ...
              {testing ? (
                ...
                <div className="bg-[#0E182A] border border-[#D4AF37]/30 rounded-xl p-3.5 text-xs text-[#F8FAFC] leading-relaxed whitespace-pre-wrap font-sans">
                  {testResult}
                </div>
              ) : (
                <div className="flex-1 flex items-center justify-center text-[#94A3B8]/60 text-xs text-center font-sans">
                  Clique em "Testar" para ver o comportamento da assistente.
                </div>
              )}
            </div>
          </div>
